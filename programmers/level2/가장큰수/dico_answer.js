...
/*
1. numbers의 요소를 JSON.stringyify()로 전부 문자열 반환한 후,
2. string으로 변환한 요소들을 sort로 내림차순 정렬한다.
3.
(b + a) - (a + b) 를 비교해서 결과값이 양수인지 음수인지에 따라 왼쪽 값이 큰 지 오른쪽 값이 큰 지를 판단한다.
그리고 큰 게 오른쪽으로 나열된다.
